...
part of 'campaign_completed_event.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

CampaignCompletedEvent _$CampaignCompletedEventFromJson(
  ...
  ($checkedConvert) {
    ...
    final val = CampaignCompletedEvent(
      ...
      type: $checkedConvert(
        'type',
        (v) => v as String? ?? 'campaign.completed',
      ),
    );
    return val;
  },
...
Map<String, dynamic> _$CampaignCompletedEventToJson(
  CampaignCompletedEvent instance,
) => <String, dynamic>{
