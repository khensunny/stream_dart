...
part 'create_call_type_response.g.dart';
...
class CreateCallTypeResponse {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is CreateCallTypeResponse &&
  ...
  factory CreateCallTypeResponse.fromJson(Map<String, dynamic> json) =>
      _$CreateCallTypeResponseFromJson(json);

  Map<String, dynamic> toJson() => _$CreateCallTypeResponseToJson(this);
