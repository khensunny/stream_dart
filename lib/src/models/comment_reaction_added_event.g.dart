...
CommentReactionAddedEvent _$CommentReactionAddedEventFromJson(
  ...
  ($checkedConvert) {
    ...
    final val = CommentReactionAddedEvent(
      ...
      type: $checkedConvert(
        'type',
        (v) => v as String? ?? 'feeds.comment.reaction.added',
      ),
      user: $checkedConvert(
        'user',
        (v) => v == null
...
Map<String, dynamic> _$CommentReactionAddedEventToJson(
  CommentReactionAddedEvent instance,
) => <String, dynamic>{
