...
class CommentReactionAddedEvent {
  /// Returns a new [CommentReactionAddedEvent] instance.
  CommentReactionAddedEvent({
    ...
    this.type = 'feeds.comment.reaction.added',
  ...
  @JsonKey(
    defaultValue: 'feeds.comment.reaction.added',
    name: r'type',
    required: true,
    includeIfNull: false,
  )
  ...
  factory CommentReactionAddedEvent.fromJson(Map<String, dynamic> json) =>
