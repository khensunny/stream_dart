...
part 'call_type_response.g.dart';
...
class CallTypeResponse {
  /// Returns a new [CallTypeResponse] instance.
  CallTypeResponse({
  ...
  factory CallTypeResponse.fromJson(Map<String, dynamic> json) =>
      _$CallTypeResponseFromJson(json);

  Map<String, dynamic> toJson() => _$CallTypeResponseToJson(this);
