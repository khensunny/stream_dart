...
part 'update_channel_type_response.g.dart';
...
class UpdateChannelTypeResponse {
  /// Returns a new [UpdateChannelTypeResponse] instance.
  ...
  final UpdateChannelTypeResponseAutomodEnum automod;
  ...
  final UpdateChannelTypeResponseAutomodBehaviorEnum automodBehavior;
  ...
  final UpdateChannelTypeResponseBlocklistBehaviorEnum? blocklistBehavior;
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is UpdateChannelTypeResponse &&
  ...
  factory UpdateChannelTypeResponse.fromJson(Map<String, dynamic> json) =>
      _$UpdateChannelTypeResponseFromJson(json);

  Map<String, dynamic> toJson() => _$UpdateChannelTypeResponseToJson(this);
...
enum UpdateChannelTypeResponseAutomodEnum {
  ...
  const UpdateChannelTypeResponseAutomodEnum(this.value);
...
enum UpdateChannelTypeResponseAutomodBehaviorEnum {
  @JsonValue(r'flag')
  flag(r'flag'),
  @JsonValue(r'block')
  block(r'block'),
  ...
  const UpdateChannelTypeResponseAutomodBehaviorEnum(this.value);
...
enum UpdateChannelTypeResponseBlocklistBehaviorEnum {
  @JsonValue(r'flag')
  flag(r'flag'),
  @JsonValue(r'block')
  block(r'block'),
  ...
  const UpdateChannelTypeResponseBlocklistBehaviorEnum(this.value);
