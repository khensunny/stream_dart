...
part 'update_external_storage_request.g.dart';
...
class UpdateExternalStorageRequest {
  /// Returns a new [UpdateExternalStorageRequest] instance.
  ...
  final UpdateExternalStorageRequestStorageTypeEnum storageType;

  bool operator ==(Object other) {
    return identical(this, other) ||
        other is UpdateExternalStorageRequest &&
            runtimeType == other.runtimeType &&
            equals(
              [awsS3, azureBlob, bucket, gcsCredentials, path, storageType],
              [
                other.awsS3,
                other.azureBlob,
                other.bucket,
  ...
  factory UpdateExternalStorageRequest.fromJson(Map<String, dynamic> json) =>
      _$UpdateExternalStorageRequestFromJson(json);

  Map<String, dynamic> toJson() => _$UpdateExternalStorageRequestToJson(this);
...
/// The type of storage to use
enum UpdateExternalStorageRequestStorageTypeEnum {
  /// The type of storage to use
  @JsonValue(r's3')
  s3(r's3'),
  ...
  const UpdateExternalStorageRequestStorageTypeEnum(this.value);
