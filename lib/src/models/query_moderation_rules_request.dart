...
part 'query_moderation_rules_request.g.dart';
...
class QueryModerationRulesRequest {
  /// Returns a new [QueryModerationRulesRequest] instance.
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is QueryModerationRulesRequest &&
  ...
  factory QueryModerationRulesRequest.fromJson(Map<String, dynamic> json) =>
      _$QueryModerationRulesRequestFromJson(json);

  Map<String, dynamic> toJson() => _$QueryModerationRulesRequestToJson(this);
