...
part 'review_queue_item_updated_event.g.dart';
...
class ReviewQueueItemUpdatedEvent {
  /// Returns a new [ReviewQueueItemUpdatedEvent] instance.
  ReviewQueueItemUpdatedEvent({
    ...
    this.type = 'review_queue_item.updated',
  });
  ...
  @JsonKey(
    defaultValue: 'review_queue_item.updated',
    name: r'type',
    required: true,
    includeIfNull: false,
  )
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is ReviewQueueItemUpdatedEvent &&
  ...
  factory ReviewQueueItemUpdatedEvent.fromJson(Map<String, dynamic> json) =>
      _$ReviewQueueItemUpdatedEventFromJson(json);

  Map<String, dynamic> toJson() => _$ReviewQueueItemUpdatedEventToJson(this);
