...
part 'activity_deleted_event.g.dart';
...
class ActivityDeletedEvent {
  /// Returns a new [ActivityDeletedEvent] instance.
  ActivityDeletedEvent({
    ...
    this.type = 'feeds.activity.deleted',
  ...
  @JsonKey(
    defaultValue: 'feeds.activity.deleted',
    name: r'type',
    required: true,
    includeIfNull: false,
  )
  ...
  factory ActivityDeletedEvent.fromJson(Map<String, dynamic> json) =>
