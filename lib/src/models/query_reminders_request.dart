...
part 'query_reminders_request.g.dart';
...
class QueryRemindersRequest {
  /// Returns a new [QueryRemindersRequest] instance.
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is QueryRemindersRequest &&
  ...
  factory QueryRemindersRequest.fromJson(Map<String, dynamic> json) =>
      _$QueryRemindersRequestFromJson(json);

  Map<String, dynamic> toJson() => _$QueryRemindersRequestToJson(this);
