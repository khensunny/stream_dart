...
MessageUndeletedEvent _$MessageUndeletedEventFromJson(
  ...
  ($checkedConvert) {
    ...
    final val = MessageUndeletedEvent(
      ...
      type: $checkedConvert('type', (v) => v as String? ?? 'message.undeleted'),
      user: $checkedConvert(
        'user',
...
Map<String, dynamic> _$MessageUndeletedEventToJson(
  MessageUndeletedEvent instance,
) => <String, dynamic>{
