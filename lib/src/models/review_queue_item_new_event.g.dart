...
part of 'review_queue_item_new_event.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ReviewQueueItemNewEvent _$ReviewQueueItemNewEventFromJson(
  ...
  ($checkedConvert) {
    ...
    final val = ReviewQueueItemNewEvent(
      ...
      type: $checkedConvert(
        'type',
        (v) => v as String? ?? 'review_queue_item.new',
      ),
    );
    return val;
  },
...
Map<String, dynamic> _$ReviewQueueItemNewEventToJson(
  ReviewQueueItemNewEvent instance,
) => <String, dynamic>{
