...
class ActivityUpdatedEvent {
  /// Returns a new [ActivityUpdatedEvent] instance.
  ActivityUpdatedEvent({
    ...
    this.type = 'feeds.activity.updated',
  ...
  @JsonKey(
    defaultValue: 'feeds.activity.updated',
    name: r'type',
    required: true,
    includeIfNull: false,
  )
  ...
  factory ActivityUpdatedEvent.fromJson(Map<String, dynamic> json) =>
