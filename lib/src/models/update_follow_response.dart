...
class UpdateFollowResponse {
  /// Returns a new [UpdateFollowResponse] instance.
  UpdateFollowResponse({required this.duration, required this.follow});
  ...
  factory UpdateFollowResponse.fromJson(Map<String, dynamic> json) =>
