...
part 'start_campaign_response.g.dart';
...
class StartCampaignResponse {
  /// Returns a new [StartCampaignResponse] instance.
  StartCampaignResponse({this.campaign, required this.duration, this.users});
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is StartCampaignResponse &&
  ...
  factory StartCampaignResponse.fromJson(Map<String, dynamic> json) =>
      _$StartCampaignResponseFromJson(json);

  Map<String, dynamic> toJson() => _$StartCampaignResponseToJson(this);
