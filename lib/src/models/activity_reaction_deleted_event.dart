...
class ActivityReactionDeletedEvent {
  /// Returns a new [ActivityReactionDeletedEvent] instance.
  ActivityReactionDeletedEvent({
    ...
    this.type = 'feeds.activity.reaction.deleted',
  ...
  @JsonKey(
    defaultValue: 'feeds.activity.reaction.deleted',
    name: r'type',
    required: true,
    includeIfNull: false,
  )
  ...
  factory ActivityReactionDeletedEvent.fromJson(Map<String, dynamic> json) =>
