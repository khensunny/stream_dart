...
part 'member_added_event.g.dart';
...
class MemberAddedEvent {
  /// Returns a new [MemberAddedEvent] instance.
  MemberAddedEvent({
  ...
  factory MemberAddedEvent.fromJson(Map<String, dynamic> json) =>
      _$MemberAddedEventFromJson(json);

  Map<String, dynamic> toJson() => _$MemberAddedEventToJson(this);
