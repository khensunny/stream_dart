...
part of 'update_channel_type_response.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

UpdateChannelTypeResponse _$UpdateChannelTypeResponseFromJson(
  ...
  ($checkedConvert) {
    ...
    final val = UpdateChannelTypeResponse(
      ...
      automod: $checkedConvert(
        'automod',
        (v) => $enumDecode(
          _$UpdateChannelTypeResponseAutomodEnumEnumMap,
          v,
          unknownValue:
              UpdateChannelTypeResponseAutomodEnum.unknownDefaultOpenApi,
        ),
      ),
      automodBehavior: $checkedConvert(
        'automod_behavior',
        (v) => $enumDecode(
          _$UpdateChannelTypeResponseAutomodBehaviorEnumEnumMap,
          v,
          unknownValue: UpdateChannelTypeResponseAutomodBehaviorEnum
      ...
      blocklistBehavior: $checkedConvert(
        ...
        (v) => $enumDecodeNullable(
          _$UpdateChannelTypeResponseBlocklistBehaviorEnumEnumMap,
          v,
          unknownValue: UpdateChannelTypeResponseBlocklistBehaviorEnum
              .unknownDefaultOpenApi,
        ),
      ),
...
Map<String, dynamic> _$UpdateChannelTypeResponseToJson(
  UpdateChannelTypeResponse instance,
) => <String, dynamic>{
  'allowed_flag_reasons': ?instance.allowedFlagReasons,
  'automod': _$UpdateChannelTypeResponseAutomodEnumEnumMap[instance.automod]!,
  'automod_behavior':
      _$UpdateChannelTypeResponseAutomodBehaviorEnumEnumMap[instance
          .automodBehavior]!,
  'automod_thresholds': ?instance.automodThresholds?.toJson(),
  'blocklist': ?instance.blocklist,
  'blocklist_behavior':
      ?_$UpdateChannelTypeResponseBlocklistBehaviorEnumEnumMap[instance
          .blocklistBehavior],
...
const _$UpdateChannelTypeResponseAutomodEnumEnumMap = {
  UpdateChannelTypeResponseAutomodEnum.disabled: 'disabled',
  UpdateChannelTypeResponseAutomodEnum.simple: 'simple',
  UpdateChannelTypeResponseAutomodEnum.AI: 'AI',
  UpdateChannelTypeResponseAutomodEnum.unknownDefaultOpenApi:
      'unknown_default_open_api',
};

const _$UpdateChannelTypeResponseAutomodBehaviorEnumEnumMap = {
  UpdateChannelTypeResponseAutomodBehaviorEnum.flag: 'flag',
  UpdateChannelTypeResponseAutomodBehaviorEnum.block: 'block',
  UpdateChannelTypeResponseAutomodBehaviorEnum.shadowBlock: 'shadow_block',
  UpdateChannelTypeResponseAutomodBehaviorEnum.unknownDefaultOpenApi:
      'unknown_default_open_api',
};

const _$UpdateChannelTypeResponseBlocklistBehaviorEnumEnumMap = {
  UpdateChannelTypeResponseBlocklistBehaviorEnum.flag: 'flag',
  UpdateChannelTypeResponseBlocklistBehaviorEnum.block: 'block',
  UpdateChannelTypeResponseBlocklistBehaviorEnum.shadowBlock: 'shadow_block',
  UpdateChannelTypeResponseBlocklistBehaviorEnum.unknownDefaultOpenApi:
      'unknown_default_open_api',
};
