...
class ChannelConfig {
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: ChannelConfigAutomodEnum.unknownDefaultOpenApi,
  )
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: ChannelConfigAutomodBehaviorEnum.unknownDefaultOpenApi,
  )
  ...
  @JsonKey(
    ...
    required: false,
    includeIfNull: false,
    unknownEnumValue: ChannelConfigBlocklistBehaviorEnum.unknownDefaultOpenApi,
  )
