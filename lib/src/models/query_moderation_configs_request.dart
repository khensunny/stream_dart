...
part 'query_moderation_configs_request.g.dart';
...
class QueryModerationConfigsRequest {
  /// Returns a new [QueryModerationConfigsRequest] instance.
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is QueryModerationConfigsRequest &&
  ...
  factory QueryModerationConfigsRequest.fromJson(Map<String, dynamic> json) =>
      _$QueryModerationConfigsRequestFromJson(json);

  Map<String, dynamic> toJson() => _$QueryModerationConfigsRequestToJson(this);
