...
class SendCallEventResponse {
  ...
  SendCallEventResponse({required this.duration});
  ...
  factory SendCallEventResponse.fromJson(Map<String, dynamic> json) =>
      _$SendCallEventResponseFromJson(json);

  Map<String, dynamic> toJson() => _$SendCallEventResponseToJson(this);
