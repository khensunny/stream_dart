...
ReactionNewEvent _$ReactionNewEventFromJson(Map<String, dynamic> json) =>
    $checkedCreate(
      'ReactionNewEvent',
      json,
      ($checkedConvert) {
        ...
        final val = ReactionNewEvent(
          ...
          type: $checkedConvert('type', (v) => v as String? ?? 'reaction.new'),
          user: $checkedConvert(
            'user',
...
Map<String, dynamic> _$ReactionNewEventToJson(ReactionNewEvent instance) =>
    <String, dynamic>{
