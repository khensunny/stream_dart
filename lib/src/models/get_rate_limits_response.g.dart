...
part of 'get_rate_limits_response.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

GetRateLimitsResponse _$GetRateLimitsResponseFromJson(
  Map<String, dynamic> json,
) => $checkedCreate('GetRateLimitsResponse', json, ($checkedConvert) {
  $checkKeys(json, requiredKeys: const ['duration']);
  final val = GetRateLimitsResponse(
...
Map<String, dynamic> _$GetRateLimitsResponseToJson(
  GetRateLimitsResponse instance,
) => <String, dynamic>{
