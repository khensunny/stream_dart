...
class FeedMemberAddedEvent {
  /// Returns a new [FeedMemberAddedEvent] instance.
  FeedMemberAddedEvent({
    ...
    this.type = 'feeds.feed_member.added',
  ...
  @JsonKey(
    defaultValue: 'feeds.feed_member.added',
    name: r'type',
    required: true,
    includeIfNull: false,
  )
  ...
  factory FeedMemberAddedEvent.fromJson(Map<String, dynamic> json) =>
