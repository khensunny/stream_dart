...
class AutomodPlatformCircumventionConfig {
  /// Returns a new [AutomodPlatformCircumventionConfig] instance.
  AutomodPlatformCircumventionConfig({this.async_, this.enabled, this.rules});
  ...
  factory AutomodPlatformCircumventionConfig.fromJson(
