...
class QueryActivityReactionsRequest {
  /// Returns a new [QueryActivityReactionsRequest] instance.
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is QueryActivityReactionsRequest &&
  ...
  factory QueryActivityReactionsRequest.fromJson(Map<String, dynamic> json) =>
