  ...
  ($checkedConvert) {
    ...
    final val = MessageResponse(
      ...
      type: $checkedConvert(
        'type',
        (v) => $enumDecode(
          _$MessageResponseTypeEnumEnumMap,
          v,
          unknownValue: MessageResponseTypeEnum.unknownDefaultOpenApi,
        ),
      ),
...
const _$MessageResponseTypeEnumEnumMap = {
  ...
  MessageResponseTypeEnum.unknownDefaultOpenApi: 'unknown_default_open_api',
};
