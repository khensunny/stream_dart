...
class BookmarkDeletedEvent {
  /// Returns a new [BookmarkDeletedEvent] instance.
  BookmarkDeletedEvent({
    ...
    this.type = 'feeds.bookmark.deleted',
  ...
  @JsonKey(
    defaultValue: 'feeds.bookmark.deleted',
    name: r'type',
    required: true,
    includeIfNull: false,
  )
  ...
  factory BookmarkDeletedEvent.fromJson(Map<String, dynamic> json) =>
