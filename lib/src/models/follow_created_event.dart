...
part 'follow_created_event.g.dart';
...
class FollowCreatedEvent {
  /// Returns a new [FollowCreatedEvent] instance.
  FollowCreatedEvent({
    ...
    this.type = 'feeds.follow.created',
  });
  ...
  @JsonKey(
    defaultValue: 'feeds.follow.created',
    name: r'type',
    required: true,
    includeIfNull: false,
  )
  ...
  factory FollowCreatedEvent.fromJson(Map<String, dynamic> json) =>
