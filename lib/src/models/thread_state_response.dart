...
class ThreadStateResponse {
  /// Returns a new [ThreadStateResponse] instance.
  ThreadStateResponse({
  ...
  @JsonKey(name: r'latest_replies', required: true, includeIfNull: false)
  ...
  factory ThreadStateResponse.fromJson(Map<String, dynamic> json) =>
      _$ThreadStateResponseFromJson(json);
