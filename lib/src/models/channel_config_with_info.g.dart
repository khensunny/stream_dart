...
ChannelConfigWithInfo _$ChannelConfigWithInfoFromJson(
  ...
  ($checkedConvert) {
    ...
    final val = ChannelConfigWithInfo(
      ...
      automod: $checkedConvert(
        'automod',
        (v) => $enumDecode(
          _$ChannelConfigWithInfoAutomodEnumEnumMap,
          v,
          unknownValue: ChannelConfigWithInfoAutomodEnum.unknownDefaultOpenApi,
        ),
      ),
      automodBehavior: $checkedConvert(
        ...
        (v) => $enumDecode(
          ...
          v,
          unknownValue:
              ChannelConfigWithInfoAutomodBehaviorEnum.unknownDefaultOpenApi,
        ),
      ),
      ...
      blocklistBehavior: $checkedConvert(
        ...
        (v) => $enumDecodeNullable(
          ...
          v,
          unknownValue:
              ChannelConfigWithInfoBlocklistBehaviorEnum.unknownDefaultOpenApi,
        ),
      ),
...
Map<String, dynamic> _$ChannelConfigWithInfoToJson(
  ...
  'automod_behavior':
      _$ChannelConfigWithInfoAutomodBehaviorEnumEnumMap[instance
          .automodBehavior]!,
  'automod_thresholds': ?instance.automodThresholds?.toJson(),
  'blocklist': ?instance.blocklist,
  'blocklist_behavior':
      ?_$ChannelConfigWithInfoBlocklistBehaviorEnumEnumMap[instance
          .blocklistBehavior],
...
const _$ChannelConfigWithInfoAutomodEnumEnumMap = {
  ...
  ChannelConfigWithInfoAutomodEnum.unknownDefaultOpenApi:
