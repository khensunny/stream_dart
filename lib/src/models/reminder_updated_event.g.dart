...
ReminderUpdatedEvent _$ReminderUpdatedEventFromJson(
  ...
  ($checkedConvert) {
    ...
    final val = ReminderUpdatedEvent(
      ...
      type: $checkedConvert('type', (v) => v as String? ?? 'reminder.updated'),
...
Map<String, dynamic> _$ReminderUpdatedEventToJson(
