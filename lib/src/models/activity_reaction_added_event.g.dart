...
part of 'activity_reaction_added_event.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ActivityReactionAddedEvent _$ActivityReactionAddedEventFromJson(
  ...
  ($checkedConvert) {
    ...
    final val = ActivityReactionAddedEvent(
      ...
      type: $checkedConvert(
        'type',
        (v) => v as String? ?? 'feeds.activity.reaction.added',
      ),
      user: $checkedConvert(
        'user',
        (v) => v == null
...
Map<String, dynamic> _$ActivityReactionAddedEventToJson(
  ActivityReactionAddedEvent instance,
) => <String, dynamic>{
