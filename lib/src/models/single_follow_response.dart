...
class SingleFollowResponse {
  /// Returns a new [SingleFollowResponse] instance.
  SingleFollowResponse({required this.duration, required this.follow});
  ...
  factory SingleFollowResponse.fromJson(Map<String, dynamic> json) =>
