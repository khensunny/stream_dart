...
part of 'comment_deleted_event.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

CommentDeletedEvent _$CommentDeletedEventFromJson(
  ...
  ($checkedConvert) {
    $checkKeys(
      json,
      requiredKeys: const ['comment', 'created_at', 'custom', 'fid', 'type'],
    );
    final val = CommentDeletedEvent(
      ...
      type: $checkedConvert(
        'type',
        (v) => v as String? ?? 'feeds.comment.deleted',
      ),
      user: $checkedConvert(
        'user',
        (v) => v == null
...
Map<String, dynamic> _$CommentDeletedEventToJson(
  CommentDeletedEvent instance,
) => <String, dynamic>{
