...
part 'get_channel_type_response.g.dart';
...
class GetChannelTypeResponse {
  /// Returns a new [GetChannelTypeResponse] instance.
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: GetChannelTypeResponseAutomodEnum.unknownDefaultOpenApi,
  )
  final GetChannelTypeResponseAutomodEnum automod;
  ...
  final GetChannelTypeResponseAutomodBehaviorEnum automodBehavior;
  ...
  final GetChannelTypeResponseBlocklistBehaviorEnum? blocklistBehavior;
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is GetChannelTypeResponse &&
  ...
  factory GetChannelTypeResponse.fromJson(Map<String, dynamic> json) =>
      _$GetChannelTypeResponseFromJson(json);

  Map<String, dynamic> toJson() => _$GetChannelTypeResponseToJson(this);
...
enum GetChannelTypeResponseAutomodEnum {
  ...
  const GetChannelTypeResponseAutomodEnum(this.value);
...
enum GetChannelTypeResponseAutomodBehaviorEnum {
  @JsonValue(r'flag')
  flag(r'flag'),
  @JsonValue(r'block')
  block(r'block'),
  ...
  const GetChannelTypeResponseAutomodBehaviorEnum(this.value);
...
enum GetChannelTypeResponseBlocklistBehaviorEnum {
  @JsonValue(r'flag')
  flag(r'flag'),
  @JsonValue(r'block')
  block(r'block'),
  ...
  const GetChannelTypeResponseBlocklistBehaviorEnum(this.value);
