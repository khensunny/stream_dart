...
part 'activity_reaction_updated_event.g.dart';
...
class ActivityReactionUpdatedEvent {
  /// Returns a new [ActivityReactionUpdatedEvent] instance.
  ActivityReactionUpdatedEvent({
    ...
    this.type = 'feeds.activity.reaction.updated',
  ...
  @JsonKey(
    defaultValue: 'feeds.activity.reaction.updated',
    name: r'type',
    required: true,
    includeIfNull: false,
  )
  ...
  factory ActivityReactionUpdatedEvent.fromJson(Map<String, dynamic> json) =>
      _$ActivityReactionUpdatedEventFromJson(json);

  Map<String, dynamic> toJson() => _$ActivityReactionUpdatedEventToJson(this);
