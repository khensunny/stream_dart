...
FeedUpdatedEvent _$FeedUpdatedEventFromJson(
  ...
  ($checkedConvert) {
    $checkKeys(
      json,
      requiredKeys: const ['created_at', 'custom', 'feed', 'fid', 'type'],
    );
    final val = FeedUpdatedEvent(
      ...
      type: $checkedConvert(
        'type',
        (v) => v as String? ?? 'feeds.feed.updated',
      ),
      user: $checkedConvert(
        'user',
        (v) => v == null
...
Map<String, dynamic> _$FeedUpdatedEventToJson(FeedUpdatedEvent instance) =>
    <String, dynamic>{
