...
GetCallResponse _$GetCallResponseFromJson(Map<String, dynamic> json) =>
    $checkedCreate('GetCallResponse', json, ($checkedConvert) {
      $checkKeys(
        json,
        requiredKeys: const ['call', 'duration', 'members', 'own_capabilities'],
      );
      final val = GetCallResponse(
        call: $checkedConvert(
          'call',
...
Map<String, dynamic> _$GetCallResponseToJson(GetCallResponse instance) =>
    <String, dynamic>{
