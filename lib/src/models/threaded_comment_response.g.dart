...
ThreadedCommentResponse _$ThreadedCommentResponseFromJson(
  ...
  ($checkedConvert) {
    ...
    final val = ThreadedCommentResponse(
      ...
      meta: $checkedConvert(
        'meta',
        (v) =>
            v == null ? null : RepliesMeta.fromJson(v as Map<String, dynamic>),
      ),
      ...
      upvoteCount: $checkedConvert('upvote_count', (v) => (v as num).toInt()),
      user: $checkedConvert(
        'user',
...
Map<String, dynamic> _$ThreadedCommentResponseToJson(
