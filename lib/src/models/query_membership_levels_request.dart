...
part 'query_membership_levels_request.g.dart';
...
class QueryMembershipLevelsRequest {
  /// Returns a new [QueryMembershipLevelsRequest] instance.
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is QueryMembershipLevelsRequest &&
  ...
  factory QueryMembershipLevelsRequest.fromJson(Map<String, dynamic> json) =>
      _$QueryMembershipLevelsRequestFromJson(json);

  Map<String, dynamic> toJson() => _$QueryMembershipLevelsRequestToJson(this);
