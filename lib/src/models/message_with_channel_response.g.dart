...
part of 'message_with_channel_response.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

MessageWithChannelResponse _$MessageWithChannelResponseFromJson(
  ...
  ($checkedConvert) {
    ...
    final val = MessageWithChannelResponse(
      ...
      channel: $checkedConvert(
        'channel',
        (v) => ChannelResponse.fromJson(v as Map<String, dynamic>),
      ),
      ...
      type: $checkedConvert(
        'type',
        (v) => $enumDecode(
          _$MessageWithChannelResponseTypeEnumEnumMap,
          v,
          unknownValue:
              MessageWithChannelResponseTypeEnum.unknownDefaultOpenApi,
        ),
      ),
...
Map<String, dynamic> _$MessageWithChannelResponseToJson(
  MessageWithChannelResponse instance,
) => <String, dynamic>{
  ...
  'thread_participants': ?instance.threadParticipants
      ?.map((e) => e.toJson())
      .toList(),
  'type': _$MessageWithChannelResponseTypeEnumEnumMap[instance.type]!,
  'updated_at': instance.updatedAt,
  'user': instance.user.toJson(),
};

const _$MessageWithChannelResponseTypeEnumEnumMap = {
  MessageWithChannelResponseTypeEnum.regular: 'regular',
  MessageWithChannelResponseTypeEnum.ephemeral: 'ephemeral',
  MessageWithChannelResponseTypeEnum.error: 'error',
  MessageWithChannelResponseTypeEnum.reply: 'reply',
  MessageWithChannelResponseTypeEnum.system: 'system',
  MessageWithChannelResponseTypeEnum.deleted: 'deleted',
  MessageWithChannelResponseTypeEnum.unknownDefaultOpenApi:
