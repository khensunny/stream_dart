...
part of 'create_channel_type_response.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

CreateChannelTypeResponse _$CreateChannelTypeResponseFromJson(
  ...
  ($checkedConvert) {
    ...
    final val = CreateChannelTypeResponse(
      ...
      automod: $checkedConvert(
        'automod',
        (v) => $enumDecode(
          _$CreateChannelTypeResponseAutomodEnumEnumMap,
          v,
          unknownValue:
      ...
      automodBehavior: $checkedConvert(
        'automod_behavior',
        (v) => $enumDecode(
          _$CreateChannelTypeResponseAutomodBehaviorEnumEnumMap,
          v,
          unknownValue: CreateChannelTypeResponseAutomodBehaviorEnum
      ...
      blocklistBehavior: $checkedConvert(
        ...
        (v) => $enumDecodeNullable(
          _$CreateChannelTypeResponseBlocklistBehaviorEnumEnumMap,
          v,
          unknownValue: CreateChannelTypeResponseBlocklistBehaviorEnum
              .unknownDefaultOpenApi,
        ),
      ),
...
Map<String, dynamic> _$CreateChannelTypeResponseToJson(
  CreateChannelTypeResponse instance,
) => <String, dynamic>{
  'allowed_flag_reasons': ?instance.allowedFlagReasons,
  'automod': _$CreateChannelTypeResponseAutomodEnumEnumMap[instance.automod]!,
  'automod_behavior':
      _$CreateChannelTypeResponseAutomodBehaviorEnumEnumMap[instance
          .automodBehavior]!,
  'automod_thresholds': ?instance.automodThresholds?.toJson(),
  'blocklist': ?instance.blocklist,
  'blocklist_behavior':
      ?_$CreateChannelTypeResponseBlocklistBehaviorEnumEnumMap[instance
          .blocklistBehavior],
...
const _$CreateChannelTypeResponseAutomodEnumEnumMap = {
