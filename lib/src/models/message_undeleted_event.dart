...
part 'message_undeleted_event.g.dart';
...
class MessageUndeletedEvent {
  /// Returns a new [MessageUndeletedEvent] instance.
  ...
  @JsonKey(
    defaultValue: 'message.undeleted',
    name: r'type',
    required: true,
    includeIfNull: false,
  )
  ...
  factory MessageUndeletedEvent.fromJson(Map<String, dynamic> json) =>
      _$MessageUndeletedEventFromJson(json);

  Map<String, dynamic> toJson() => _$MessageUndeletedEventToJson(this);
