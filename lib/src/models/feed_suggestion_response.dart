...
class FeedSuggestionResponse {
  /// Returns a new [FeedSuggestionResponse] instance.
  ...
  @JsonKey(name: r'algorithm_scores', required: false, includeIfNull: false)
  ...
  @JsonKey(name: r'recommendation_score', required: false, includeIfNull: false)
  ...
  factory FeedSuggestionResponse.fromJson(Map<String, dynamic> json) =>
