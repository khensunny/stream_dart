...
ReminderDeletedEvent _$ReminderDeletedEventFromJson(
  ...
  ($checkedConvert) {
    ...
    final val = ReminderDeletedEvent(
      ...
      type: $checkedConvert('type', (v) => v as String? ?? 'reminder.deleted'),
...
Map<String, dynamic> _$ReminderDeletedEventToJson(
