...
part 'reminder_deleted_event.g.dart';
...
class ReminderDeletedEvent {
  /// Returns a new [ReminderDeletedEvent] instance.
  ...
  factory ReminderDeletedEvent.fromJson(Map<String, dynamic> json) =>
      _$ReminderDeletedEventFromJson(json);

  Map<String, dynamic> toJson() => _$ReminderDeletedEventToJson(this);
