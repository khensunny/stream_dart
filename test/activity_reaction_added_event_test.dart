...
// tests for ActivityReactionAddedEvent
void main() {
  final ActivityReactionAddedEvent?
  instance = /* ActivityReactionAddedEvent(...) */ null;
  // TODO add properties to the entity

  group(ActivityReactionAddedEvent, () {
    ...
    // String type (default value: 'feeds.activity.reaction.added')
