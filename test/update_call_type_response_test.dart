...
// tests for UpdateCallTypeResponse
void main() {
  final UpdateCallTypeResponse? instance = /* UpdateCallTypeResponse(...) */
      null;
  // TODO add properties to the entity

  group(UpdateCallTypeResponse, () {
    ...
    test('to test the property `notificationSettings`', () async {
      // TODO
    });
