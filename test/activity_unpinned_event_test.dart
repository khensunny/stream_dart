...
// tests for ActivityUnpinnedEvent
void main() {
  final ActivityUnpinnedEvent? instance = /* ActivityUnpinnedEvent(...) */ null;
  // TODO add properties to the entity

  group(ActivityUnpinnedEvent, () {
    ...
    test('to test the property `feedVisibility`', () async {
      // TODO
    });
    ...
    test('to test the property `pinnedActivity`', () async {
      // TODO
    });
    ...
    // String type (default value: 'feeds.activity.unpinned')
