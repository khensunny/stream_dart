...
// tests for FeedMemberUpdatedEvent
void main() {
  final FeedMemberUpdatedEvent? instance = /* FeedMemberUpdatedEvent(...) */
      null;
  // TODO add properties to the entity

  group(FeedMemberUpdatedEvent, () {
    ...
    // String type (default value: 'feeds.feed_member.updated')
