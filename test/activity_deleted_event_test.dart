...
// tests for ActivityDeletedEvent
void main() {
  final ActivityDeletedEvent? instance = /* ActivityDeletedEvent(...) */ null;
  // TODO add properties to the entity

  group(ActivityDeletedEvent, () {
    ...
    // String type (default value: 'feeds.activity.deleted')
