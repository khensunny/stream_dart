...
// tests for ReminderUpdatedEvent
void main() {
  final ReminderUpdatedEvent? instance = /* ReminderUpdatedEvent(...) */ null;
  // TODO add properties to the entity

  group(ReminderUpdatedEvent, () {
    ...
    // String type (default value: 'reminder.updated')
