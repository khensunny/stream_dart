...
// tests for CallSessionEndedEvent
void main() {
  final CallSessionEndedEvent? instance = /* CallSessionEndedEvent(...) */ null;
  // TODO add properties to the entity

  group(CallSessionEndedEvent, () {
    // CallResponse call
    ...
    // String type (default value: 'call.session_ended')
