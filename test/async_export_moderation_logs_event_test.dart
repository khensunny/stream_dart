...
// tests for AsyncExportModerationLogsEvent
void main() {
  final AsyncExportModerationLogsEvent?
  instance = /* AsyncExportModerationLogsEvent(...) */ null;
  // TODO add properties to the entity

  group(AsyncExportModerationLogsEvent, () {
    // num createdAt
    ...
    // String type (default value: 'export.moderation_logs.success')
