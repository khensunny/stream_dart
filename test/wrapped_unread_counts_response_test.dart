...
// tests for WrappedUnreadCountsResponse
void main() {
  final WrappedUnreadCountsResponse?
  instance = /* WrappedUnreadCountsResponse(...) */ null;
  // TODO add properties to the entity

  group(WrappedUnreadCountsResponse, () {
    ...
    test('to test the property `totalUnreadThreadsCount`', () async {
      // TODO
    });
  });
}
