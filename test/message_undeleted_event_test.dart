...
// tests for MessageUndeletedEvent
void main() {
  final MessageUndeletedEvent? instance = /* MessageUndeletedEvent(...) */ null;
  // TODO add properties to the entity

  group(MessageUndeletedEvent, () {
    // String channelId
    ...
    // String type (default value: 'message.undeleted')
